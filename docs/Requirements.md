...
| FR9 | The system shall provide global menu settings, including preload of the breathing API, preload of the GenAI API, UI zoom level, and reset-to-default behaviour. | <span className="moscow-badge moscow-badge--must">Must</span> |
| FR10 | The system shall provide per-game settings and store them locally so they persist between sessions. | <span className="moscow-badge moscow-badge--should">Should</span> |
| FR11 | The system shall allow users or caregivers to rate each game on a 0-5 scale, including half-star values, and reuse those ratings for sorting. | <span className="moscow-badge moscow-badge--should">Should</span> |
| FR12 | The system shall provide help and navigation support through in-app help pages, back/home navigation, and support information. | <span className="moscow-badge moscow-badge--should">Should</span> |
